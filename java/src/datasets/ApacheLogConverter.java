...
public class ApacheLogConverter extends WebLogConverter {
	...
	public void addLogInDatabase(String log, LogDatabase database) {
		 ...
		 * 192.168.174.8 - - [23/Mar/2015:18:04:44 +0000] "GET /index.php HTTP/1.1" 200 350 "-" "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.101 Safari/537.36"
		 * 
